...
public class Ch1_QuizActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCheatButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {				
				Intent i = new Intent(Ch1_QuizActivity.this, Ch5_CheatActivity.class);
				i.putExtra(Ch5_CheatActivity.EXTRA_ANSWER_IS_TRUE, mQuestionBank[mCurrentIndex].isTrueQuestion());
...
//		savedInstanceState.putParcelableArray(QUESTION_BANK, mQuestionBank);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		mQuestionBank[mCurrentIndex].setHasCheated(data.getBooleanExtra(Ch5_CheatActivity.EXTRA_ANSWER_SHOWN, false));
	}
